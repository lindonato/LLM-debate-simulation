...
model_options = [
    ...
    {"name": "Mixtral Instruct-8x22B ", "model_name": "mistralai/Mixtral-8x22B-Instruct-v0.1", "api_key": together_api_key, "base_url": "https://api.together.xyz/v1"},
    {"name": "Mixtral Instruct-8x7B ", "model_name": "mistralai/Mixtral-8x7B-Instruct-v0.1", "api_key": together_api_key, "base_url": "https://api.together.xyz/v1"},
    {"name": "Qwen 2 Instruct-72B ", "model_name": "Qwen/Qwen2-72B-Instruct", "api_key": together_api_key, "base_url": "https://api.together.xyz/v1"},
    {"name": "Qwen 1.5 Chat-72B", "model_name": "Qwen/Qwen1.5-72B-Chat", "api_key": together_api_key, "base_url": "https://api.together.xyz/v1"}
]
